    ...
    <div className="w-full border-gray-500 p-10 rounded-lg bg-white text-center">
      ...
      <div className="grid grid-cols-3 gap-4 space-y-4 mt-4 text-center">
        <div className="border border-gray-300 bg-white p-4 rounded-xl shadow-lg flex flex-col h-full">
          ...
          <button
            className="mt-auto px-4 py-2 bg-blue-500 text-white rounded-md"
            onClick={() => {
              console.log("📌 Google 번역 저장:", translations.google);
              onSave(translations.google);
            }}
          >
            저장하기
          </button>
        ...
        <div className="border border-gray-300 bg-white p-4 rounded-xl text-center shadow-lg flex flex-col h-full">
          ...
          <button
            className="mt-auto px-4 py-2 bg-blue-500 text-white rounded-md"
            onClick={() => {
              console.log("📌 Papago 번역 저장:", translations.papago);
              onSave(translations.papago);
            }}
          >
            저장하기
          </button>
        ...
        <div className="border border-gray-300 bg-white p-4 rounded-xl text-center shadow-lg flex flex-col h-full">
          ...
          <button
            className="mt-auto px-4 py-2 bg-blue-500 text-white rounded-md"
            onClick={() => {
              console.log("📌 DeepL 번역 저장:", translations.deepL);
              onSave(translations.deepL);
            }}
          >
            저장하기
          </button>
